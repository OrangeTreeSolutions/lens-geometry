...
const curve1 = new index_1.Circle(7.896, 4.3);
const curve2 = new index_1.Circle(11.4, 0.5);
...
describe("Test Simple Lens Profile (validated in focalpoints (APEX-C2))", () => {
    ...
    it("should pass through 4.3, 1.274 ", () => {
        chai_1.expect(lensp.sag(4.3)).closeTo(1.274, 0.001);
    });
    it("should end at 4.8, 1.491 ", () => {
        chai_1.expect(lensp.sag(4.8)).closeTo(1.491, 0.001);
    });
    // random point chosen and validated in focalpoints with mouse hover (X,Z)
    it("should pass through 4.456, 1.383", () => {
        chai_1.expect(lensp.sag(4.56)).closeTo(1.383, 0.001);
    });
});
//# sourceMappingURL=test.LensProfile.js.map